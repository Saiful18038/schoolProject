...
(23, 'manarat', 'manarat@yahoo.com', '7894', '7894', 'uploadAdmin/miu.jpg', 22),
(24, 'MDJAHIDHASAN', 'jahid@yahoo.com', '789', '789', 'uploadAdmin/plant.png', 0),
(25, 'DidderAlam', 'didderalam1343@gmail.com', '123', '123', 'uploadAdmin/300by300Didder.jpg', 0);
...
INSERT INTO `exam` (`e_id`, `pid`, `bangla`, `english`, `math`, `moral`, `science`, `social`) VALUES
(33, 206, 80, 90, 80, 90, 80, 80),
(38, 205, 80, 80, 80, 60, 90, 82),
(39, 207, 80, 80, 90, 70, 90, 90);
...
(4, 'juel', 'salary', '5000', 'paid', '01765603878', 'mdjuel@gmail.com', '12/5/22'),
(5, 'robin khan', 'salary', '450', 'paid', '01625478535456', 'hgfhkhjhkjg@htrf', 'zxvdfsdfsd');
...
(35, 'dfsfsfsd', 'xvxvc', 'zcxzvzvz', '2022-06-13 23:46:25');
...
(202, 'images/received_1988420214738933.jpeg', 'khan', 'male', 'dddd', 'rangpur', '0176565', 'ghfhf@gmail.com'),
(203, 'images/kk.jpeg', 'ads', 'male', 'sfdfgd', 'dadf', '0142544', 'dafda@yahoo.com'),
(208, 'images/p3.jpg', 'Rofiq', 'male', 'sdjfljsdfl', 'dhaka', '0155489623669', 'didfjlkejri@gmail.com');
...
INSERT INTO `student` (`student_id`, `Pass`, `image`, `fname`, `lname`, `father_name`, `enroll_year`, `dob`, `class`, `gender`, `academic_year`) VALUES
(205, '123', 'images/received_1988419518072336.jpeg', 'hasan', 'hasan', 'asss', '2011', '1998', '11', 'male', 2022),
(206, '123', 'images/Didder.jpg', 'Didder', 'Alam', '............', '2017', '19/11/1994', '7', 'male', 2017),
(207, '123', 'images/d4max7m-68b3e810-e470-47f5-b960-0dc21ce07d18.jpg', 'Shahida', 'Sumi', '............', '2017', '19/11/2011', '10', 'female', 2017),
(208, '123', 'images/p1.png', 'Mamun', 'Islam', 'Sheikh Hamid', '2017', '10/10/16', '10', 'male', 2022),
(214, '123', 'images/p12.jpg', 'Ekramul', 'Hasan', 'arif kahn', '2020', '10/10/16', '7', 'male', 2022),
(215, '123', 'images/p4.jpg', 'Sajjaddul ', 'Rahman', 'HJ', '2020', '10/10/16', '8', 'male', 2022),
(216, '123', 'images/p9.jpg', 'Babul', 'Rahman', 'HJ', '2020', '10/10/16', '8', 'male', 2022);
...
INSERT INTO `teacher` (`id`, `pass`, `fname`, `lname`, `address`, `qualification`, `city`, `state`, `zip`, `phone`, `email`, `gender`) VALUES
(119, '123', 'Hasan', 'Ali', 'Dhaka', 'BSc in CSE, Manarat International University', 'Dhaka', 'Savar', '1343', '01765607854', 'mdjuel@gmail.com', 'male'),
(120, '123', 'Ekramul', 'Haque', 'Dhaka', 'BBA', 'Dhaka', 'Savar', '1343', '01765603878', 'ekramul@gmail.com', 'female'),
(121, '123', 'Bristy', 'Akter', 'Narsingdi ', 'BSc in CSE', 'Narsingdi ', 'Narsingdi ', '1602', '01554589854', 'shahida@gmail.com', 'female'),
(122, '123', 'Md. Zunaid', 'Hossain', 'Savar, Dhaka', 'BSc in EEE', 'Savar', 'Dhaka', '1343', '016xxxxxxxxxxxx', 'zunaid@gamil.com', 'male'),
(123, '', 'Azom', 'Khan', 'Dhaka', 'BSc', 'Dhaka', 'Dhaka', '1343', '0190xxxxxxxxxxx', 'fasdfsdf@gdsadf', 'male');
...
(19, 'dhaka', '14', 'hasem', '45875', '01765603878');
...
--
ALTER TABLE `exam`
  MODIFY `e_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `notices`
  MODIFY `n_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `student`
  MODIFY `student_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;

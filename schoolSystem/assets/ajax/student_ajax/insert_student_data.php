    ...
    if ($_FILES["file"]["size"] > 500000) {
        ...
        $uploadOk = 0;
                ...
                if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
                    $sql="INSERT INTO student( image, fname, lname, father_name, enroll_year, dob, class, gender, academic_year, Pass) VALUES 
                        ('$img','$fname','$lname','$father_name','$enroll_year','$dob','$class','$gender','$academic_year', '$Pass')";
